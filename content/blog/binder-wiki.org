...
It now has internal linking and a better menu flow based on parent-child relationships between entries as seen on this page. ~bndr~ still serves as markup language with the addition of ~>[internal]~ syntax for internal links. For example I'll link bank to the parent [[file:binder.org][binder]] article using this new syntax.
...
New changes can be found here on this [[https://github.com/v3rse/binder/tree/v0.1][tag v0.1]]
